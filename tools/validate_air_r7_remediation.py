...
def main():
 ...
 req(idx['status']=='AIR_2_6_3_OBJECT_CONTRACT_SET_008_FIVE_PACKAGE_INDEX_V074_RELEASE_SEALED_REPLAYABLE_BEHAVIORAL_VALIDATED','v074 release-sealed index status incoherent')
 req(idx['catalog_scope']['catalog_completeness_claim']=='COMPLETE_FOR_AIR_2_6_3_OBJECT_CONTRACT_SET_008_V074_RELEASE_SPECIALIST_CATALOG','v074 release completeness identity incoherent')
 ...
 req(all(load(ROOT/'tests'/fn).get('candidate_foundation_runtime_fingerprint')=='060bb6b415affa57d93b9672c62f54b823f23d026a82ab60032c861591439d07' for fn in ['AIR_AI_GOVERNANCE_SET008_BEHAVIORAL_EVIDENCE_V2.json', 'AIR_CAPABILITY_ECOLOGY_ARCHITECT_SET008_BEHAVIORAL_EVIDENCE_V2.json', 'AIR_PUBLIC_SURFACE_COPYWRITING_SET008_BEHAVIORAL_EVIDENCE_V2.json', 'AIR_SPECIFICATION_FIRST_VERIFICATION_SET008_BEHAVIORAL_EVIDENCE_V2.json', 'AIR_GROUNDING_SET008_BEHAVIORAL_EVIDENCE_V2.json']),'V2 behavioral evidence candidate Foundation runtime fingerprint mismatch')
 ...
 req(cpvs.get('release_catalog_registration')=='INCLUDED_IN_SET_008_V074_RELEASE_CATALOG','Copywriting v0.7.4 release catalog registration mismatch')
 evp=ROOT/'tests/AIR_PUBLIC_SURFACE_COPYWRITING_SET008_BEHAVIORAL_EVIDENCE_V2.json'; req(evp.is_file(),'Copywriting behavioral evidence file missing'); ev=load(evp); er=cwman.get('behavioral_evidence_receipt',{})
 req(meta(evp)['sha256']=='d4fc20633a61b3fe390d9e69cb9ea977e99054b1c0ab9dd2b17c01d59ca65711' and er.get('sha256')=='d4fc20633a61b3fe390d9e69cb9ea977e99054b1c0ab9dd2b17c01d59ca65711','Copywriting behavioral evidence hash mismatch')
 req(ev.get('evidence_id')=='AIR_BEHAVIORAL_EVIDENCE_PUBLIC_SURFACE_COPYWRITING_SET008_20260917_V2' and ev.get('summary',{}).get('pass_count')==6 and ev.get('summary',{}).get('scenario_count')==6 and ev.get('summary',{}).get('behavioral_revalidation_result')=='PASS_ON_CURRENT_MODEL_HOST','Copywriting behavioral evidence result mismatch')
 ...
 req(spvs.get('release_catalog_registration')=='INCLUDED_IN_SET_008_V074_RELEASE_CATALOG_WITH_EXECUTOR_DRAFT_UNAVAILABLE','SFV v0.7.4 release catalog registration mismatch')
 ...
 sfvevp=ROOT/'tests/AIR_SPECIFICATION_FIRST_VERIFICATION_SET008_BEHAVIORAL_EVIDENCE_V2.json'; req(sfvevp.is_file(),'SFV behavioral evidence file missing'); sfvev=load(sfvevp); sfver=sfvman.get('behavioral_evidence_receipt',{})
 req(meta(sfvevp)['sha256']=='3d511ba200e6f017c97141e7c1316959cd52e38bf19b8887c97a0a3bd4ccf5ec' and sfver.get('sha256')=='3d511ba200e6f017c97141e7c1316959cd52e38bf19b8887c97a0a3bd4ccf5ec','SFV behavioral evidence hash mismatch')
 req(sfvev.get('evidence_id')=='AIR_BEHAVIORAL_EVIDENCE_SPECIFICATION_FIRST_VERIFICATION_SET008_20260917_V2' and sfvev.get('summary',{}).get('pass_count')==6 and sfvev.get('summary',{}).get('scenario_count')==6 and sfvev.get('summary',{}).get('behavioral_revalidation_result')=='PASS_ON_CURRENT_MODEL_HOST','SFV behavioral evidence result mismatch')
 ...
 req(gmpvs.get('release_catalog_registration')=='INCLUDED_IN_SET_008_V074_RELEASE_CATALOG_WITH_EXECUTOR_DRAFT_UNAVAILABLE','Grounding v0.7.4 release catalog registration mismatch')
 ...
 groundevp=ROOT/'tests/AIR_GROUNDING_SET008_BEHAVIORAL_EVIDENCE_V2.json'; req(groundevp.is_file(),'Grounding behavioral evidence file missing'); groundev=load(groundevp); grounder=groundman.get('behavioral_evidence_receipt',{})
 req(meta(groundevp)['sha256']=='8675a95d211e6673191526fff3749e88d3d8a9273b2803d30357438850209a26' and grounder.get('sha256')=='8675a95d211e6673191526fff3749e88d3d8a9273b2803d30357438850209a26','Grounding behavioral evidence hash mismatch')
 req(groundev.get('evidence_id')=='AIR_BEHAVIORAL_EVIDENCE_GROUNDING_SET008_20260917_V2' and groundev.get('summary',{}).get('pass_count')==6 and groundev.get('summary',{}).get('scenario_count')==6 and groundev.get('summary',{}).get('behavioral_revalidation_result')=='PASS_ON_CURRENT_MODEL_HOST','Grounding behavioral evidence result mismatch')
 ...
 govevp=ROOT/'tests/AIR_AI_GOVERNANCE_SET008_BEHAVIORAL_EVIDENCE_V2.json'; req(govevp.is_file(),'Governance behavioral evidence file missing'); govev=load(govevp); gover=gov.get('behavioral_evidence_receipt',{})
 req(meta(govevp)['sha256']=='75e8a18cb45418b5421871580b91c4ef7e4b6aa273f89f892a9d615178ce726b' and gover.get('sha256')=='75e8a18cb45418b5421871580b91c4ef7e4b6aa273f89f892a9d615178ce726b','Governance behavioral evidence hash mismatch')
 req(govev.get('evidence_id')=='AIR_BEHAVIORAL_EVIDENCE_AI_GOVERNANCE_SET008_20260917_V2' and govev.get('summary',{}).get('pass_count')==6 and govev.get('summary',{}).get('scenario_count')==6 and govev.get('summary',{}).get('behavioral_revalidation_result')=='PASS_ON_CURRENT_MODEL_HOST','Governance behavioral evidence result mismatch')
 ...
 ceaevp=ROOT/'tests/AIR_CAPABILITY_ECOLOGY_ARCHITECT_SET008_BEHAVIORAL_EVIDENCE_V2.json'; req(ceaevp.is_file(),'CEA behavioral evidence file missing'); ceaev=load(ceaevp); ceaer=cea.get('behavioral_evidence_receipt',{})
 req(meta(ceaevp)['sha256']=='507d8128d889d93ae98770858f879b4f5304e4a32f21385e612eca6ab4cb3b6e' and ceaer.get('sha256')=='507d8128d889d93ae98770858f879b4f5304e4a32f21385e612eca6ab4cb3b6e','CEA behavioral evidence hash mismatch')
 req(ceaev.get('evidence_id')=='AIR_BEHAVIORAL_EVIDENCE_CAPABILITY_ECOLOGY_ARCHITECT_SET008_20260917_V2' and ceaev.get('summary',{}).get('pass_count')==6 and ceaev.get('summary',{}).get('scenario_count')==6 and ceaev.get('summary',{}).get('behavioral_revalidation_result')=='PASS_ON_CURRENT_MODEL_HOST','CEA behavioral evidence result mismatch')
