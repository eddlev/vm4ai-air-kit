...
def main() -> None:
    ...
    run_stage('v072_candidate_seal', [py, 'tools/validate_air_v072_release_seal.py'])
    ...
    if not args.without_mutations:
        ...
        run_stage('v072_candidate_seal_mutations', [py, 'tools/test_air_v072_release_seal_mutations.py'])
